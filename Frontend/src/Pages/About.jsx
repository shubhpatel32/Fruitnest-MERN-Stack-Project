        ...
        <div className='min-h-screen'>
            ...
            <section className="about">
                <div className="w-full my-4">
                    ...
                    <p className="text-black text-justify text-3xl leading-10 tracking-wide mb-4 normal-case">
                        Join us on this flavorful journey where health meets taste, and discover why Fruitnest is your trusted partner in bringing nature's goodness right to your home.
                    </p>
                </div>
            </section>
