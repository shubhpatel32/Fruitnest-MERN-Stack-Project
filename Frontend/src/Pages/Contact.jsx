        ...
        <div className="min-h-screen">
            ...
            <section className="contact flex flex-col min-h-screen">
                ...
                <div className="icons-container w-full gap-8 grid md:grid-cols-3 grid-cols-1">
                    <div className="icons text-center border-2 border-solid border-[#a8a297] p-8 rounded-lg">
                    ...
                    <div className="icons text-center border-2 border-solid border-[#a8a297] p-8 rounded-lg">
                        ...
                        <a href="mailto:fruitnest.21@gmail.com" className="text-2xl text-black normal-case hover:text-[#cf1a1a]">fruitnest.21@gmail.com</a>
                    </div>
                ...
                <div className="my-8 border-2 border-solid border-[#a8a297]  p-8 bg-white rounded-lg">
                ...
                <div className="grid grid-cols-1 w-full h-[40rem] md:h-[40rem] mt-8">
                    {/* Google Maps iframe */}
                    <iframe
                        className="map border-2 border-solid border-[#a8a297] w-full h-full rounded-lg"
